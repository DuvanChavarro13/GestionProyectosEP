...
class EmpleadoController extends Controller
{
    ...
    //Busqueda
    public function show(Request $request, $iden)
    {
        return Empleado::where('identificacion','=',$iden)->get();
    }
    ...
    //eliminar empleado 
    public function destroy(Request $request, $iden)
    {
        $empleadoAEliminar = Empleado::where('identificacion','=',$iden)->first();
